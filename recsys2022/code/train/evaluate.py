...
out_dir = "/home/vmagent/app/transformer4rec_recsys2022/data/data_feat/eval"
num_train_epochs = 15
...
model = tr.Model(head)
model.load_state_dict(torch.load("/home/vmagent/app/transformer4rec_recsys2022/data/data_feat/models/checkpoint-107610/pytorch_model.bin"))
...
predictions_np = pd.DataFrame(predictions.numpy())
predictions_np.to_csv(os.path.join(out_dir,"prediction.csv"))
labels_np = pd.DataFrame(labels.numpy())
labels_np.to_csv(os.path.join(out_dir,"label.csv"))
